...
import pcre
# import offline_data_handler as ESHandler
...
#         host=host,
#         user='rsa_user_test',
#         passwd='xvfx1b9xhbktz58pe5k7',
#         database='rsa_chatbot_db_test'
#     )
#     # self.database = app.mysql
#     time = None
...
def init(app): 
    ...
    # self.error = ""
    # self.total_lookup = 0
    host = app.config['MYSQL']['HOSTS']  
    user = app.config['MYSQL']['USER']
    pwd = app.config['MYSQL']['PASSWD']
    db = app.config['MYSQL']['DATABASE']
